...
<body class="gray-background">
    ...
    <form class="card white-background shadow" action="getInformation.php" id="form1" method="post">
        ...
        <div class="input-field">
            ...
            <div>
                <p>Email*</p>
                <div class="input-bar"><input name="Email" class="Email-to-verify" required type="email"  /></div>
            </div>
            <div>
        ...
        <div class="confirm-field" id="signUpBlock">
            <input class="button create-account"  style="background-color: grey;" name="submit" value="S'inscrire"
