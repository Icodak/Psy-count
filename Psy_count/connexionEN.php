...
try{
      ...
      if (!$resultat)
      {
         $_SESSION['message2']='unvalid password or ID';
         header('Location: signInEN.php');
      ...
      else
      {
        ...
        $req3 =  $dbco->prepare(
          ...
          if(count($resultat4)!=0){
            $_SESSION['message2']= 'You have been banned by an admin';
            header('Location: signInEN.php');
          }else{
      if ($isPasswordCorrect) {
        ...
        $_SESSION['message2']= 'unvalid password or Email address';
        header('Location: signInEN.php');
      }
      }
    }
