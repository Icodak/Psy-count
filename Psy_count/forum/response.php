...
<div class="response-container shadow">
    <div class="response-field" id="response-field">
        <img class="small-img" src="../../images_utilisateurs/<?php echo $_SESSION['image'] ?>" alt="User Profile">
            ...
            <textarea id="topicResponse" contenteditable="true" class="input-field response" name="message" placeholder="Poster une réponse" onclick='this.style.height = "" + Math.max(this.style.height.slice(0,-2),200) + "px"; getElementById("response-submit").style.display = "flex";'>
            </textarea>
